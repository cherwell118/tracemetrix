# opls functions (adapted from ropls package)
# Modified by ZiruChen \email{chenziru@@picb.ac.cn}
...
#'
#' @title opls
#' @description opls function adapted from ropls package
#' @author Etienne A. Thevenot \email{etienne.thevenot@cea.fr}, modified by Ziru Chen \email{chenziru@@picb.ac.cn}.
