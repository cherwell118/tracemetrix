#' @title fixed_polr
#' @description A new polr function modified from file MASS/R/polr.R which fixed bug. copyright (C) 1994-2008 W. N. Venables and B. D. Ripley.Modified by Tim J. Benham. More information see: https://r.789695.n4.nabble.com/bugs-and-misfeatures-in-polr-MASS-fixed-td3024677.html#a3030405. This R function script downloaded from:  http://biostat.mc.vanderbilt.edu/wiki/pub/Main/CharlesDupontStuff/newPolr.R
...
#' @param Hess Hess.
#' @param model model.
#' @param method c("logistic", "probit", "cloglog", "cauchit").
...
#
fixed_polr <- function(formula, data, weights, start, ..., subset,
